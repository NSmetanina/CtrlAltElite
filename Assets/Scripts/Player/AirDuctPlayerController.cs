...
public class AirDuctPlayerController : MonoBehaviour        
{
    // wasd movement system , this player controller is different because the movement has to be 
    ...
    {
        transform.position += (direction) * speed * Time.deltaTime; // Direction is minus 1 because of the camera
    }
